...
-------------------UC4 Retrive data by select statement--------------------

select * from employee_payroll;

------------------UC5 Retriveing particular data by condition----------------
...
inner join EmpDept on EmpDept.Employee_Id=Employee.EmployeeID
inner join DepartmentTable on DepartmentTable.DepartmentId=EmpDept.Dept_Id; 
...
from Company
inner join Employee on Company.CompanyID=Employee.Company_Id and Employee.EmployeeName='Nivetha';
